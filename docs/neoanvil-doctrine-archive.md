...
> ⚠️ **ARCHIVO HISTÓRICO — NO SEGUIR COMO DOCTRINA ACTIVA.** NeoAnvil está **PARQUEADO**
> desde 2026-07-21. Su MCP no está registrado en Claude Code (ninguna tool `mcp__neoanvil__*`
> existe en la sesión), así que nada de lo de abajo — BRIEFING, `neo_radar`, certify, tiers,
> modos pair/fast/daemon — es aplicable. Doctrina viva mínima: [`../CLAUDE.md`](../CLAUDE.md).
> Este documento se conserva solo como referencia para un eventual revive.
